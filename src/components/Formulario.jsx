    ...
    return (
        <div className='md:w-1/2 lg:w-2/5 m-2'>
            ...
            className='bg-white shadow-md rounded-lg py-10 px-5 mb-10'>
                ...
                <div className="mb-5">
                    <label 
                        className='block text-gray font-bold uppercase' 
                        htmlFor="mascota">
                            Nombre mascota
                    </label>

                    <input type="text" id="mascota"
                            placeholder="N. mascota"
                            value={nombre}
                            onChange={(e) => setNombre(e.target.value)}
                            className='border-2 w-full p-2 mt-2 placeholder:text-gray-400 rounded-lg'
                    />
                </div>
                <div className="mb-5">
                    <label 
                ...
                <div className="mb-5">
                    ...
                    <textarea 
                     ...
                     {error && <Error mensaje='Debes llenar los campos' />}
